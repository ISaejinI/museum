            ...
            <div className="grid grid-cols-1 items-stretch gap-16 lg:grid-cols-2 lg:gap-24">
                <section className="flex flex-col justify-center">
                    ...
                    <p className="mt-8 text-sm">
                        ...
                        <TransitionLink href="/register" className="inline-flex items-center gap-1 uppercase tracking-widest text-(--hightlight-orange) hover:underline">
                            Créer un compte
